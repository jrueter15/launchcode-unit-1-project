  ...
  return (
    <div>
        ...
        <p>
            ...
            This project provided an opportunity to pause and reflect — not just on what I was building, but why I hadn’t been progressing the way I wanted to.
        </p>
        <br></br>
        ...
        <p>
            ...
            <ul>
                <li>Create a calm, judgment-free space to log small daily wins.</li>
            ...
            This is for anyone trying to change quietly, not loudly. Patiently, not perfectly. I built it for myself, and maybe it can help you, too.       
        </p>
    </div>
  )
}
